...
# 项目模块导入
from styles import (UnifiedStyleHelper, ModernLineEdit, BaseFramelessDialog,
                   DialogFactory, ChineseMessageBox, get_global_font_manager)

from utils import load_icon_universal


class AnimatedConfirmDialog(BaseFramelessDialog):
    """带动画效果的确认对话框"""
...
class CustomInputDialog(BaseFramelessDialog):
    ...
    def __init__(self, parent=None):
        ...
        # 字体管理器已通过BaseFramelessDialog自动获取
        self.font_manager = get_global_font_manager()
    ...
    def setup_ui(self):
        ...
        # 顶部边距40px为标题栏留出空间
        layout.setContentsMargins(25, 40, 25, 20)  # 调整边距
