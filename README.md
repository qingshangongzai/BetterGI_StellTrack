...
**BetterGI StellTrack（BetterGI 星轨）**是一款专为 **BetterGI**（一款**《原神》**自动化辅助工具）打造的键鼠脚本生成与管理工具，用于生成键鼠自动化脚本。本工具基于 PyQt6 开发，提供了直观的可视化界面，允许用户创建自动化操作序列。其核心功能是实现游戏内的延时摄影——通过自动控制图片的截取和保存，创作延时摄影作品，是一个为“留影机”提供自动化控制的工具。
...
- [ ] 增加暗色主题，并提供切换菜单（暗色主题尝试过很多次，效果都不理想）
