...
BetterGI StellTrack 在技术上具有多项亮点和创新，体现了现代 GUI 应用开发的最佳实践：

### 1. 现代化 UI 设计

- **WinUI 3 风格**：采用现代化的 WinUI 3 设计语言，提供流畅的用户体验
...
BetterGI StellTrack 采用了规范的开发流程，确保代码质量和项目进度：
...
- [x] 复选框点击后无法正常显示
- [x] 菜单栏点开后会有灰边和直角
- [x] 打开对话框窗口闪烁（大部分已经通过打开动画进行覆盖，但部分情况可能还是会出现闪烁的情况）
- [ ] 圆角不符合WinUI3规范
- [ ] 标题栏（窗口栏）修改为纯白色
- [x] 增加过渡动画
- [ ] 批量编辑页面输入框长度不一致
